...
design_libs=(xil_defaultlib xlslice_v1_0_3)
...
compile()
{
  ...
  vlogan -work xlslice_v1_0_3 $vlogan_opts +v2k \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/connor/Documents/mips/mips-core/mips-core.cache/compile_simlib/vcs"
  fi
