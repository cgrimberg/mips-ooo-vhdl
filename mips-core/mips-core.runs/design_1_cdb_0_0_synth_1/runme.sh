...
HD_PWD='/home/connor/Documents/mips/mips-core/mips-core.runs/design_1_cdb_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_cdb_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_cdb_0_0.tcl
